    ...
    <div className="mt-10 bg-[#061A30]">
      <div className="mx-auto mt-5 grid max-w-[1200px] select-none grid-cols-2 gap-10">
        <div className="col-span-2 md:col-span-1">
          <p className="font-extralight text-white">
            ...
            itaque suscipit ipsum reiciendis hic quibusdam quae impedit fuga
            ullam perferendis aut veniam quidem repudiandae quos cupiditate!
            Rerum, placeat hic! Lorem ipsum dolor, sit amet consectetur
            adipisicing elit. Rerum odit recusandae saepe ducimus animi,
            asperiores iure unde vero voluptas? Doloremque veniam non aspernatur
            nulla harum, quas deserunt cupiditate quis adipisci.
          </p>
        </div>
        <div className="col-span-2 md:col-span-1">
      ...
      <footer className="footer mx-auto max-w-screen-xl p-10 text-gray-200">
          ...
          <div>
            <div className="flex items-center gap-1">
              <Image
                ...
                className="mr-3 w-16"
              />
              <h2 className="text-xl font-bold text-[#3388FF]">ASIA SPORTS</h2>
            </div>
            <div className="mt-6 select-none text-center text-base md:text-start">
              <h2 className="text-white">Asia Sports is the best</h2>
              <h2 className="text-white">Football App</h2>
            </div>
          </div>
        </nav>
        ...
        <nav className="mx-auto space-y-2 md:mx-0">
          <h4 className="mx-auto select-none text-lg font-extralight text-white md:mx-0">
            Get the App
          </h4>
          <div className="mx-auto flex gap-4 md:mx-0">
            <Link
              href="/"
              className="flex h-8 w-8 items-center justify-center rounded-full p-2 text-white ring-1 ring-blue-500 transition-all duration-150 ease-in hover:text-[#3388FF]"
            >
      ...
      <div className="my-4 flex justify-center">
        <span className="text-md flex select-none items-center gap-1 text-[#6B7276] sm:text-center">
          <p className="text-center">
            <span className="mx-1 mb-1">
              <FaRegCopyright className=" inline-block text-sm text-[#6B7276]" />
            </span>
